...
gdjs.evtsExt__Jump3D__TopZ.userFunc0xddf6d8 = function GDJSInlineCode(runtimeScene, objects, eventsFunctionContext) {
"use strict";
if (objects.length === 0) {
    return;
}
...
gdjs.evtsExt__Jump3D__TopZ.userFunc0xddf6d8(runtimeScene, objects, typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined);
